...
const GovtAdminSettings = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Government Admin Settings</h1>
      <p className="text-gray-600 mb-8">Manage your government administrative account</p>
...
export default GovtAdminSettings;
